...
public class PokemonFase1Agua extends PokemonAgua implements IPokemon, PokemonFase1 {

    private VisitorPokemon visitor = new VisitorPokemon();
    public PokemonFase1Agua(String nombre, int id, int salud, ArrayList<IHabilidad> ataques){

...
public class PokemonBasicoLucha extends PokemonLucha implements IPokemon, PokemonBasico {

    private VisitorPokemon visitor = new VisitorPokemon();
    public PokemonBasicoLucha(String nombre, int id, int salud, ArrayList<IHabilidad> ataques){

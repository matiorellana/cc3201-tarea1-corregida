...
public abstract class PokemonPlanta extends Pokemon implements IPokemon {

    public PokemonPlanta(String nombre, int id, int salud, ArrayList<IHabilidad> ataques) {
